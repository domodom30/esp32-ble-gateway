...
public:
  ...
  static size_t getLoginLen();
  static void setLogin(const char *val, size_t len);
  ...
  static char *getStaticMask();
  static void setStaticMask(const char *val, size_t len);
  static char *getStaticGw();
  static void setStaticGw(const char *val, size_t len);
  static char *getStaticDns();
  static void setStaticDns(const char *val, size_t len);
...
private:
  ...
  static char *staticGw;
  static char *staticDns;
